...
pcall(function()
    if game.CoreGui:FindFirstChild("KevinHub") then game.CoreGui.KevinHub:Destroy() end
end)
pcall(function()
    if playerGui:FindFirstChild("KevinHub") then playerGui.KevinHub:Destroy() end
end)

local GUI = Instance.new("ScreenGui")
GUI.Name="KevinHub"; GUI.ResetOnSpawn=false; GUI.IgnoreGuiInset=true
...
LogoBG.Color=ColorSequence.new(Color3.fromRGB(255,80,80), Color3.fromRGB(190,20,20))
LogoBG.Rotation=135
LogoBG.Parent=Logo
...
TitleL.Text='<font color="rgb(255,90,90)">Kevin</font> <font color="rgb(255,190,190)" size="10">Hub</font>'
TitleL.TextSize=12
...
OnBtn.MouseButton1Click:Connect(function()
    ...
    if _enabled then
        ...
        OnBtn.TextColor3=Color3.fromRGB(8,8,12)
        setStatus(_focused and "Ready â€” watching" or "Click the code box first",
...
UserInputService.TextBoxFocused:Connect(function(box)
    _focused=box
    if _enabled then setStatus("Ready â€” watching",T.Green) end
end)
