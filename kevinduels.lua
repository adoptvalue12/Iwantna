...
local RED_ACCENT = Color3.fromRGB(255, 40, 40)
local RED_DIM = Color3.fromRGB(200, 30, 30)
local RED_DARK = Color3.fromRGB(12, 2, 2)
local RED_ROW = Color3.fromRGB(25, 6, 6)
local RED_BTN = Color3.fromRGB(18, 4, 4)
local RED_TOGGLE = Color3.fromRGB(40, 8, 8)
local RED_GRAD_TOP = Color3.fromRGB(30, 6, 6)
local RED_GRAD_BOT = Color3.fromRGB(8, 1, 1)

UI_ACCENT = RED_ACCENT
UI_ACCENT_DIM = RED_DIM
UI_BG_DARK = RED_DARK
UI_ROW_BG = RED_ROW
UI_BTN_BG = RED_BTN
UI_TOGGLE_OFF = RED_TOGGLE
UI_TOGGLE_KNOB = Color3.fromRGB(200, 50, 50)
UI_KNOB_ON = Color3.fromRGB(255, 255, 255)
UI_TEXT_PRIMARY = Color3.fromRGB(255, 255, 255)
UI_TEXT_WHITE = Color3.fromRGB(255, 255, 255)
UI_TEXT_DIM = Color3.fromRGB(200, 150, 150)
UI_TEXT_SECTION = RED_ACCENT
UI_CARD_STROKE = RED_DIM
UI_GRAD_TOP = RED_GRAD_TOP
UI_GRAD_BOT = RED_GRAD_BOT
CHERRY_ACCENT = RED_ACCENT
...
function M.createPlayerSpeedGui(plr)
    ...
    label.Text = "0"
    label.TextColor3 = RED_ACCENT
    label.Font = Enum.Font.GothamBold
    label.TextScaled = true
    label.TextStrokeTransparency = 0
    M.addShimmerToLabel(label, RED_ACCENT, Color3.fromRGB(255,255,255))
    local conn
...
function M.addESP(plr)
    ...
    highlight.OutlineColor = RED_ACCENT
...
function M.setupHeadIndicator(char)
    ...
    discordLbl.Text="discord.gg/K92JgMUnCG"
...
function M.buildStatusUI()
    ...
    frame.BackgroundColor3 = RED_DARK
    ...
    barBg.BackgroundColor3 = RED_DARK
...
function M.enableAntiLag()
    ...
    M.defLightAmbient = M.defLightAmbient or Lighting.OutdoorAmbient    Lighting.GlobalShadows = false
...
local CHERRY_THEMES = {
    ...
    Red      = { Accent=Color3.fromRGB(255,40,40),   AccentDim=Color3.fromRGB(200,30,30),   Bg=Color3.fromRGB(12,2,2),    Row=Color3.fromRGB(25,6,6) },
...
UI_ACCENT = Color3.fromRGB(255, 40, 40)
UI_ACCENT_DIM = Color3.fromRGB(200, 30, 30)
UI_BG_DARK = Color3.fromRGB(12, 2, 2)
UI_ROW_BG = Color3.fromRGB(25, 6, 6)
UI_BTN_BG = Color3.fromRGB(18, 4, 4)
UI_TOGGLE_OFF = Color3.fromRGB(40, 8, 8)
UI_CARD_STROKE = Color3.fromRGB(200, 30, 30)
UI_GRAD_TOP = Color3.fromRGB(30, 6, 6)
UI_GRAD_BOT = Color3.fromRGB(8, 1, 1)
CHERRY_ACCENT = Color3.fromRGB(255, 40, 40)
...
local function saveCherryConfig()
    ...
    local cfg = {
        Theme="Red", colorScheme="Red", menuOpen=M.menuOpen~=false,
...
local function applyAccentFromTheme()
    local name = "Red"
    local t = CHERRY_THEMES.Red
    local accent = t.Accent
    local dim = t.AccentDim

    local bg  = themeDarkFromAccent(accent, 0.10)
    local row = themeDarkFromAccent(accent, 0.18)
    local btn = themeDarkFromAccent(accent, 0.22)
    local tog = themeDarkFromAccent(accent, 0.28)
...
local UI_ACCENT       = Color3.fromRGB(255, 40, 40)
local UI_ACCENT_DIM   = Color3.fromRGB(200, 30, 30)
local UI_BG_DARK      = Color3.fromRGB(12, 2, 2)
local UI_ROW_BG       = Color3.fromRGB(25, 6, 6)
local UI_CARD_STROKE  = Color3.fromRGB(200, 30, 30)
local UI_TEXT_WHITE   = Color3.fromRGB(255,255,255)
local UI_TEXT_PRIMARY = Color3.fromRGB(255, 255, 255)
local UI_TEXT_DIM     = Color3.fromRGB(200, 150, 150)
local UI_TEXT_SECTION = Color3.fromRGB(255, 40, 40)
local UI_BTN_BG       = Color3.fromRGB(18, 4, 4)
local UI_TOGGLE_OFF   = Color3.fromRGB(40, 8, 8)
local UI_TOGGLE_KNOB  = Color3.fromRGB(200, 50, 50)
local UI_KNOB_ON      = Color3.fromRGB(255, 255, 255)
local UI_GRAD_TOP     = Color3.fromRGB(30, 6, 6)
local UI_GRAD_BOT     = Color3.fromRGB(8, 1, 1)
...
local function uiCardStyle(f)
    ...
    local s = Instance.new("UIStroke"); s.Thickness = 1; s.Color = UI_CARD_STROKE; s.Transparency = 0.45; s.ApplyStrokeMode = Enum.ApplyStrokeMode.Border; s.Parent = f
...
function M.buildGui()
    ...
    do
        ...
        t.Text = 'KEVIN <font color="#FF4444">DUEL</font>'
    ...
    do
        local l=Instance.new("TextLabel"); l.Size=UDim2.new(1,0,1,0); l.BackgroundTransparency=1; l.Text="KEVIN DUEL"; l.TextColor3=UI_ACCENT; l.TextSize=13; l.Font=Enum.Font.GothamBlack; l.Parent=MinPill
    ...
    M.applyStealBarTheme(RED_ACCENT)
    M.updateHeadTheme()
    M.applyFOV()
...
function M.applyStealBarTheme(accentColor)
    local col = accentColor or RED_ACCENT
    if M.statusFill then
        M.statusFill.BackgroundColor3 = col
    end
    if M.statusDot then
...
M.buildGui()
pcall(function()
    if M.applyStealBarTheme then M.applyStealBarTheme(RED_ACCENT) end
...
print("Kevin Hub duel loaded successfully!")
return M
